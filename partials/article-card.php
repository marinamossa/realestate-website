<div class="blog__article">
	...
	<div class="blog__article-about">
		<h4 class="blog__article-about-title">
			<?= e($article['title']); ?>
		</h4>

		<div class="blog__article-meta">
		        <a
                href="<?= page_url('blog.php?' . http_build_query(['category' => $article['category']])); ?>"
                class="blog__article-category">
                <?= e($article['category']); ?>
                 </a>
		...
		<p class="blog__article-about-text">
			<?= e($article['description']); ?>
		</p>

		<a
			href="<?= article_url($article['slug']); ?>"
			class="blog__article-link"
		>
			Learn more
		</a>
	</div>
